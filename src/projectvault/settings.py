...
DATABASE_NAME = 'projectvault'             # Or path to database file if using sqlite3.
DATABASE_USER = 'projectvault'             # Not used with sqlite3.
DATABASE_PASSWORD = 'bla'         # Not used with sqlite3.
